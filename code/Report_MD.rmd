...
questions were answered, making assumptions at times and identifying potential weaknesses associated with using the dataset for decision making purposes. The focus is on a particular county of interest for a few questions. 
...
A1 <- ggplot(Q1, aes(x="", y=counts/sum(counts), fill=modevarlabel)) + geom_bar(stat="identity", width=0.5) +
...
A1a = ggplot(Q1a, aes(x="", y=count/sum(count), fill=pvtnat)) + geom_bar(stat="identity", width=0.5) +
...
print("Five of the several areas having lesser number of people travelling by private means on an average:")
head(names(cpvt))
...
print("Five of the several areas having lesser number of people travelling by public means on an average:")
head(names(cpub))
...
print("Five of the several areas where on an average lesser number of people leaving house outside 8-9 am:")   
head(names(y))
...
print("Five of the several areas where on an average lesser number of people take more than 45 mins to travel:")
head(names(x))
```
